  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: ListTile(
        ...
        title: Text(items,overflow: TextOverflow.ellipsis,style: TextStyle(fontWeight: FontWeight.w500,)),
        subtitle:  Text(items1,overflow: TextOverflow.ellipsis,style: TextStyle()),
      ),
    );
  }
}
