                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: MediaQuery.of(context).size.height * .02),
                        Text(
                          'About Mr.Musik',style: TextStyle( fontSize: 24.0,fontWeight: FontWeight.bold),
                        ...
                        ListTile(
                          ...
                          title: Text('Music Library',style: TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: Text('Access your entire music collection.',style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        ListTile(
                          leading: Icon(Icons.equalizer),
                          title: Text('Equalizer',style: TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: Text('Customize the audio settings to match your preferences.',style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        SizedBox(height: MediaQuery.of(context).size.height * .01),
                        ListTile(
                          leading: Icon(Icons.playlist_play),
                          title: Text('Playlists',style: TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: Text('Create and manage your personalized playlists.',style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        ...
                        ListTile(
                          ...
                          subtitle: Text('9400879756',style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ),
